...
(function () {
    ...
    Chart.prototype.exportCustomCanvas = function ( fileType, fileName) {
      return exportCanvas( this.canvas, fileType, fileName);
    }
    ...
    Legend.prototype.render = function () {
        ...
        for (var i = 0; i < this.dataSeries.length; i++) {
            ...
            var markerSize = (!dataSeries.markerSize && (dataSeries.type === "line" || dataSeries.type === "stepLine" || dataSeries.type === "spline")) ? 0 : this.lineHeight;
            ...
            if (dataSeries.type !== "pie" && dataSeries.type !== "doughnut" && dataSeries.type !== "funnel") {
                var item = {
                    markerType: markerType, markerColor: markerColor, text: legendText, textBlock: null, chartType: dataSeries.type, markerSize: markerSize, lineColor: "FFFFFFF",
                ...
                for (var dataPointIndex = 0; dataPointIndex < dataSeries.dataPoints.length; dataPointIndex++) {
                    ...
                    var markerSize = ((dataPoint.markerSize === 0 || (dataSeries.markerSize === 0 && !dataPoint.markerSize))) ? 0 : this.lineHeight;
        ...
        if (items.length > 0) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (this.orientation === "horizontal") {
                    ...
                    row.width += Math.round(item.textBlock.width + item.textBlock._lineHeight + (row.width === 0 ? 0 : item.textBlock._lineHeight * .5)) + 5;
                    row.items.push(item);
            ...
            this.height = rows.length * (this.lineHeight + 10);
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            for (var itemIndex = 0; itemIndex < row.items.length; itemIndex++) {
                ...
                var legendX = item.textBlock.x + left + (itemIndex === 0 ? item.markerSize * .2 : (this.lineHeight * .4) + (itemIndex * item.markerSize * .2));
                var legendY = top + (i * item.markerSize * 1.5);
                ...
                item.textBlock.x = legendX + item.markerSize + 4;
        ...
        if (this.type === "axisX" && this.chart.plotInfo.axisXValueType === "dateTime") {
            ...
            for (i = this.intervalstartTimePercent; i < endPoint; addToDateTime(i, this.interval, this.intervalType)) {
                ...
                textBlock = new TextBlock(this.ctx, {
                    ...
                    horizontalAlign: this.labelAlign,//left, center, right
    ...
    var CanvasJS = {
        ...
        Chart: function (containerId, options) {
            ...
            this.exportCustomCanvas = function ( fileType, fileName ) { _chart.exportCustomCanvas( fileType, fileName ) };
        },
    ...
    //console.log("*** SET window.CanvasJS to " + window.CanvasJS)
